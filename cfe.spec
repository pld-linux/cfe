...
cfe jest edytorem fontów konsolowych dla Linuksa, pracującym zarówno
na konsoli jak i terminalu. Posiada takie możliwości, jak różne
przekształcenia fontów, wielostopniowe cofanie i porównywanie dwóch
fontów.
